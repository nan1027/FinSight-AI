...
try:
    ...
    raise ModuleNotFoundError(
        ...
        "Install it in the project environment before running this multivariate LSTM training script."
    ) from exc

X_TRAIN_PATH = Path("data/processed/multivariate_X_train.npy")
Y_TRAIN_PATH = Path("data/processed/multivariate_y_train.npy")
X_VAL_PATH = Path("data/processed/multivariate_X_val.npy")
Y_VAL_PATH = Path("data/processed/multivariate_y_val.npy")
